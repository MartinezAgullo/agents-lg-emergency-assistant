...
from src.firewall import get_firewall_stats, validate_input
...
def main():
    ...
    print_test(
        "Coordinate Validation - Out of Range", invalid_coordinates, should_pass=False
    )
    ...
    print_test(
        "Severity Validation - Invalid Value", invalid_severity, should_pass=False
    )

    # ============== EDGE CASES ==============

    empty_input = {"assets": [], "dangers": []}
